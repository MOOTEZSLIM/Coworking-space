...
Reclamation:: Reclamation(int CODER,QString CAS)
    {
        this->CODER=CODER;
        this->CAS=CAS;
    }
  ...
  QSqlQueryModel*Reclamation::afficher()
  {
      ...
      QSqlQueryModel*model=new QSqlQueryModel();
           ...
           model->setHeaderData(0, Qt::Horizontal,QObject::tr("CODER"));
           model->setHeaderData(1, Qt::Horizontal,QObject::tr("CINR"));
           model->setHeaderData(2, Qt::Horizontal,QObject::tr("TYPE_R"));
           model->setHeaderData(3, Qt::Horizontal,QObject::tr("CIN_C"));
           model->setHeaderData(4, Qt::Horizontal,QObject::tr("ES"));
           model->setHeaderData(5, Qt::Horizontal,QObject::tr("FB"));
           model->setHeaderData(6, Qt::Horizontal,QObject::tr("CIN_E"));
           model->setHeaderData(7, Qt::Horizontal,QObject::tr("RDA"));
           model->setHeaderData(8, Qt::Horizontal,QObject::tr("ID_S"));
           model->setHeaderData(9, Qt::Horizontal,QObject::tr("INCONV"));
           model->setHeaderData(10, Qt::Horizontal,QObject::tr("NOM_S"));
           model->setHeaderData(11, Qt::Horizontal,QObject::tr("RDAS"));
           model->setHeaderData(12, Qt::Horizontal,QObject::tr("CAS"));
  ...
  bool Reclamation ::supprimer(int CODER)
  {
...

    {
     ...
     bool Reclamation ::modify(int CODER,QString CAS)
     {
         QSqlQuery query;
         query.prepare("UPDATE RECLAMATION SET CAS=:CAS WHERE CODER=:CODER");
     ...
     QSqlQueryModel*Reclamation::tri_solved()
     {
         ...
         QSqlQueryModel*model=new QSqlQueryModel();
              ...
              model->setHeaderData(1, Qt::Horizontal,QObject::tr("CODER"));
              model->setHeaderData(2, Qt::Horizontal,QObject::tr("CINR"));
              model->setHeaderData(3, Qt::Horizontal,QObject::tr("TYPE_R"));
              model->setHeaderData(4, Qt::Horizontal,QObject::tr("CIN_C"));
              model->setHeaderData(5, Qt::Horizontal,QObject::tr("ES"));
              model->setHeaderData(7, Qt::Horizontal,QObject::tr("FB"));
              model->setHeaderData(8, Qt::Horizontal,QObject::tr("CIN_E"));
              model->setHeaderData(9, Qt::Horizontal,QObject::tr("RDA"));
              model->setHeaderData(10, Qt::Horizontal,QObject::tr("ID_S"));
              model->setHeaderData(9, Qt::Horizontal,QObject::tr("INCONV"));
              model->setHeaderData(10, Qt::Horizontal,QObject::tr("NOM_S"));
              model->setHeaderData(11, Qt::Horizontal,QObject::tr("RDAS"));
              model->setHeaderData(12, Qt::Horizontal,QObject::tr("CAS"));
