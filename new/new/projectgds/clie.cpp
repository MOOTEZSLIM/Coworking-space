...
void Clie::on_radioButton_toggled(bool checked)
{
...
void Clie::on_radioButton_2_toggled(bool checked)
{
   if (checked == true){
...
void Clie::on_radioButton_3_toggled(bool checked)
{
   if (checked == true){
...
void Clie::on_statistique_clicked()
{
   stati s;
   s.exec();
}

void Clie::on_pb_pdf_clicked()
{
...
void Clie::on_pb_rechercher_clicked()
{
...
void Clie::on_table_clicked(const QModelIndex &index)
{
...
void Clie::on_tarif_clicked()
{     c.tarif();
   ui->table->setModel(c.afficher());
}

void Clie::on_radioButton_4_toggled(bool checked)
{
   if (checked == true){
