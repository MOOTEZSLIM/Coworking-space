...
int stati::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTT where TYPEAB like 'Silver'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int stati::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTT where TYPEAB like 'Bronze'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int stati::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTT where TYPEAB like 'Gold'") ;
    while(requete.next())
    {
            count++ ;
    }
